...
def main():
    ...
    parser.add_argument(
        "src_dir", default="aligned_images/", help="Directory with images for morphing"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--loss_dir", default="loss", help="Directory for storing loss values"
    )
    parser.add_argument(
        "--frs_config_path",
        type=str,
    ...
    parser.add_argument(
        "--model_url",
        default="models/StyleGAN_finetuned_ICAO.pkl",
        help="Fetch a finetuned StyleGAN model to train on from this URL",
    )
    parser.add_argument(
        "--model_res",
        default=1024,
    ...
    parser.add_argument(
        "--load_resnet",
        default="models/finetuned_resnet.h5",
        ...
        for loss_dict in pbar:
            ...
            if args.output_video and (vid_count % args.video_skip == 0):
                ...
                for i, name in enumerate(names):
                    video_frame = Image.fromarray(batch_frames[i], "RGB").resize(
